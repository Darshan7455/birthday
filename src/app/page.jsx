...
export default function HomePage() {
  ...
  // Centralized audio control function
  const playAudio = (src) => {
  ...
  const screens = [
    ...
    <IntroScreen key="intro" playAudio={playAudio} onNext={() => setCurrentScreen(2)} />,
    <CakeScreen key="cake" onNext={() => setCurrentScreen(3)} />,
    <PhotosScreen key="photos" playAudio={playAudio} onNext={() => setCurrentScreen(4)} />,
